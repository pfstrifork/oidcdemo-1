...
public class DemoApplication implements CommandLineRunner {
	...
	@Override
	public void run(String... args) throws CertificateException, FileNotFoundException, InvalidJwtException {
		...
		X509Certificate cert = (X509Certificate)certificateFactory.generateCertificate(new FileInputStream("oidc_public.pem"));
		...
		logger.info("Scope er " + jwtClaims.getClaimValue("scope"));
